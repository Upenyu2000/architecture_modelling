...
def main() -> None:
    ...
    print("Storage smoke test passed: project/folder/prefix traversal protection, safe filenames, atomic replacement, empty-file rejection, size limits and temporary-file cleanup.")
